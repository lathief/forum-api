...
describe('end point add reply', () => {
  ...
  describe('when POST /threads/{threadId}/comments/{commentId}/replies', () => {
    ...
    it('should response 404 when thread not found', async () => {
      ...
      const { accessToken } = await AccessTestHelper
    ...
    it('should response 201 and persisted reply', async () => {
      ...
      const { accessToken, userId } = await AccessTestHelper
        .getAccessTokenAndUserIdHelper({ server });
      const threadId = 'thread-123';
      const commentId = 'comment-123';
  ...
  describe('DELETE /threads/{threadId}/comments/{commentId}/replies/{replyId}', () => {
    ...
    it('should response 401 when user not owner', async () => {
      ...
      const { accessToken, userId } = await AccessTestHelper.getAccessTokenAndUserIdHelper({ server });
      const threadId = 'thread-123';
      const commentId = 'comment-123';
      const replyId = 'reply-123';
